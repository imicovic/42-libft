...
SRC 	= ft_isalpha.c ft_isdigit.c ft_isalnum.c ft_isascii.c ft_isprint.c \
		  ft_strlen.c ft_strlcpy.c ft_strlcat.c ft_atoi.c ft_bzero.c ft_memset.c \
		  ft_memcpy.c ft_memmove.c ft_toupper.c ft_tolower.c ft_strchr.c ft_strrchr.c \
		  ...
		  ft_putchar_fd.c ft_putstr_fd.c ft_putendl_fd.c ft_split.c ft_lstnew.c \
